 ...
 *   Package Operations
 *   ------------------
 *   It spawns Child Builder Processes for Build Server Processing with input of number of Processes from GUI-Client.
 *   
        ...
        void processMessages()
        {
            while (true)
            {
                ...
                if (msg.command != null)
                {
                    ...
                    if (msg.command.Equals("numberOfProcesses"))
                    {
                        Console.Write("\n\n  numberOfProcesses recieved from GUI-Client: {0}\n", msg.numberOfProcesses);
                        numberOfProcesses = Convert.ToInt32(msg.numberOfProcesses);
